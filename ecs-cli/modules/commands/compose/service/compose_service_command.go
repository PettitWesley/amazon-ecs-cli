...
func createServiceCommand(factory composeFactory.ProjectFactory) cli.Command {
	return cli.Command{
		...
		Flags:        append(append(deploymentConfigFlags(true), append(loadBalancerFlags(), flags.OptionalConfigFlags()...)...), flags.OptionalLaunchTypeFlag(), flags.OptionalCreateLogsFlag(), daemonSchedulingFlag()),
...
func upServiceCommand(factory composeFactory.ProjectFactory) cli.Command {
	return cli.Command{
		...
		Flags:        append(append(append(append(deploymentConfigFlags(true), append(loadBalancerFlags(), flags.OptionalConfigFlags()...)...), ComposeServiceTimeoutFlag()), flags.OptionalLaunchTypeFlag(), flags.OptionalCreateLogsFlag()), ForceNewDeploymentFlag(), daemonSchedulingFlag()),
...
func daemonSchedulingFlag() cli.Flag {
	return cli.BoolFlag{
		Name:  flags.DaemonFlag,
		Usage: "[Optional] Launch the Service using the DAEMON scheduling strategy",
	}
}
