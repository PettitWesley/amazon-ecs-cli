...
func UpCommand() cli.Command {
	return cli.Command{
		...
		Flags:  append(clusterUpFlags(), command.OptionalClusterFlag(), command.OptionalRegionFlag(), command.OptionalClusterConfigFlag(), command.OptionalProfileConfigFlag()),
	}
}
...
func DownCommand() cli.Command {
	return cli.Command{
		...
		Flags:  append(clusterDownFlags(), command.OptionalClusterFlag(), command.OptionalRegionFlag(), command.OptionalClusterConfigFlag(), command.OptionalProfileConfigFlag()),
	}
}
...
func ScaleCommand() cli.Command {
	return cli.Command{
		...
		Flags:  append(clusterScaleFlags(), command.OptionalClusterFlag(), command.OptionalRegionFlag(), command.OptionalClusterConfigFlag(), command.OptionalProfileConfigFlag()),
	}
}
...
func PsCommand() cli.Command {
	return cli.Command{
		...
		Flags:  []cli.Flag{command.OptionalClusterFlag(), command.OptionalRegionFlag(), command.OptionalClusterConfigFlag(), command.OptionalProfileConfigFlag()},
	}
}
